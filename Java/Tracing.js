...
var Main = function () {
    ...
    Interceptor.attach(Module.findExportByName(null, "__loader_android_dlopen_ext"), {
        onEnter: function (args) {
            ...
            if(soName.indexOf("tersafe")!= -1){
                console.log("__loader_dlopen load :" + soName);
            }
        },
    ...
    Java.perform(function () { // avoid java.lang.ClassNotFoundException
        [
            ...
            'com.tencent.gcloud.tsssdk.OneSDK_Tss',
            'com.tencent.tpns.dataacquisition.DeviceInfos',
            'com.tencent.tersafe2.TP2Sdk',
            'com.tencent.tp.n'
        ].forEach(traceClass);
